...
mediation_analysis_for_alpha_diversity <- function( 
  ...
  indirect_CI_lower <- quantile(bootstrap_indirect_effects, probs = 0.025, na.rm = TRUE)
  indirect_CI_upper <- quantile(bootstrap_indirect_effects, probs = 0.975, na.rm = TRUE)
  ...
  results <- data.frame(
    ...
    CI_Lower = c(total_CI_lower, direct_CI_lower, indirect_CI_lower),
    CI_Upper = c(total_CI_upper, direct_CI_upper, indirect_CI_upper),
